...
public class Partida {
	...
	/**
	 * Metodo que genenera aleatoriamente una de las distintas preguntas del programa
	 * @return preguntaAleatoria    genera un numero que identifica a cada una de las preguntas 
	 */
	 ...
	 * @param tipoPartida     Numero que define un tipo de partidas @see CostantesTipoPartida
	...
	/**
	 * Contenido de informacion para que el usuario eliga que tipo de partida quiere juegar
	 */
	...
	private static void creacionJugadores(int cantidadJugadores) {
		for (int numeroJugador = 0; numeroJugador < ConstantesJugador.MAX_JUGADORES; numeroJugador++) {
			if (numeroJugador < cantidadJugadores) {
				...
				jugadores[numeroJugador] = new Jugador(nombreJugador); //Numero de jugadores humanos que van a jugar la partida

			} else {
				jugadores[numeroJugador] = new Jugador("CPU" + numeroJugador); //Numero de jugadaores CPU de la partida
	 ...
	 * @return hasAcertado    Nos devuleve true si hemos acertado en la pregunta, false si no.
	 */
	...
	/**
	 * Nos da el numero de turnos que se van a jugar en cada una de las partidas segun el tipo de partida
	 * @see ConstantesTipoPartida
	 * @param tipoPartida  Numero que nos indica el tipo de partida que se va a jugar 
